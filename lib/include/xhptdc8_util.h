...
extern "C" {
	...
	#define XHPTDC8_APPLY_YAML_INVALID_CONFS_STRUTC		-23
	...
	#define XHPTDC8_APPLY_YAML_INVALID_TRIGGER_FALL		-51
	#define XHPTDC8_APPLY_YAML_INVALID_TRIGGER_RISING	-52
	#define XHPTDC8_APPLY_YAML_INVALID_TRIGGER_STRUCT	-53
	#define XHPTDC8_APPLY_YAML_ERR_TRIGGER_EXCEED_MAX	-54
	...
	#define XHPTDC8_APPLY_YAML_ERR_TGRBLCKS_EXCEED_MAX	-120

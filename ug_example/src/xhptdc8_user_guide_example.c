...
#include <windows.h>
#endif
#include "../../include/crono_interface.h"
#include "../../include/xHPTDC8_interface.h"
...
void print_hit(TDCHit* hit) {
	...
	printf("Channel %u - Time %lu - Type %x", hit->channel, hit->time, hit->type);
	if (adc_data)
